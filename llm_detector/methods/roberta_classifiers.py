# functions used to train DNN based binary classifiers for detection
...
# train a roberta model (base or large), for more information, see https://github.com/openai/gpt-2-output-dataset/tree/master/detector
...
# train a roberta sentinel model, for more information, see https://arxiv.org/pdf/2305.07969.pdf
...
# train a t5 sentinel model, for more information, see https://arxiv.org/pdf/2305.07969.pdf
    ...
    def train_func(self, data):
        ...
        for epoch in range(1, self.params['num_epochs'] + 1):
            ...
            if self.model_name == 'roberta_base' or self.model_name == 'roberta_large':
                ...
                train_loss = train_t5_sentinel(self.classification_model, self.classification_tokenizer, optimizer, self.device, train_loader, self.params['accumulaiton_steps'], positive_token_id, negative_token_id)
        ...
        # return self.classification_model, self.classification_tokenizer 
                evaluation.detection_eval(None, self.classification_model, self.model_name)
                sys.exit()
        # --------- exp temp ---------
